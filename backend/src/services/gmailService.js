...
export const sendVerificationEmail = async (email, code, username) => {
  try {
    ...
    const mailOptions = {
      from: `"Work Progress Tracker" <${process.env.GMAIL_USER}>`,
      to: email,
    ...
    console.log('✅ Gmail verification email sent:', result.messageId);
...
export const sendPasswordResetEmail = async (email, newPassword, username) => {
  try {
    ...
    console.log('✅ Gmail password reset email sent:', result.messageId);
