    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      ...
      <div className="container mx-auto px-6 py-8">
        <div className="mb-8 animate-slide-in">
          ...
          <p className="text-purple-200">Submit your monthly action implementation reports</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <div className="glass rounded-2xl shadow-xl p-6 backdrop-blur-xl border border-white/20 card-hover animate-fade-in">
            ...
            <div className="text-sm text-purple-300 mb-1">Total Actions</div>
        ...
        {loading ? (
          <div className="text-center py-20">
            ...
            <p className="text-purple-200 mt-4">Loading action reports...</p>
          </div>
        ) : reports.length === 0 ? (
          <div className="glass rounded-3xl shadow-2xl p-16 text-center backdrop-blur-xl border border-white/20 animate-fade-in">
            ...
            <h3 className="text-2xl font-bold text-white mb-3">No Action Reports Available</h3>
            <p className="text-purple-200 max-w-md mx-auto">
              Action reports will appear once the main branch creates actions for annual plans
            </p>
          </div>
        ) : (
              ...
              <table className="w-full">
                <thead className="bg-white/5 border-b border-white/10">
                  <tr>
                    ...
                    <th className="px-6 py-4 text-left text-xs font-semibold text-purple-300 uppercase tracking-wider">Plan Activity</th>
                    <th className="px-6 py-4 text-left text-xs font-semibold text-purple-300 uppercase tracking-wider">Actual</th>
                    <th className="px-6 py-4 text-left text-xs font-semibold text-purple-300 uppercase tracking-wider">Implementation %</th>
                  ...
                  {reports.map((report) => (
                    <tr key={report.id} className="hover:bg-white/5 transition">
                      <td className="px-6 py-4 text-sm text-white max-w-xs">
                        <div className="font-medium mb-1">Action {report.action_number}</div>
